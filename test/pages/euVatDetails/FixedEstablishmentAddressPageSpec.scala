...
class FixedEstablishmentAddressPageSpec extends PageBehaviours {
  ...
  "FixedEstablishmentAddressPage" - {
    ...
    beSettable[FixedEstablishmentAddress](euVatDetails.FixedEstablishmentAddressPage(index))

    beRemovable[FixedEstablishmentAddress](euVatDetails.FixedEstablishmentAddressPage(index))
  }
}
