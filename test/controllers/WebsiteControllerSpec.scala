...
class WebsiteControllerSpec extends SpecBase with MockitoSugar {
  ...
  val formProvider = new WebsiteFormProvider()
  val form = formProvider()

  lazy val websiteRoute = routes.WebsiteController.onPageLoad(NormalMode).url
  ...
  "Website Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(WebsitePage, "answer").success.value
