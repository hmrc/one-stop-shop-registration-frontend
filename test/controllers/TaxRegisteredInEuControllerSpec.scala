...
import forms.TaxRegisteredInEuFormProvider
...
import views.html.TaxRegisteredInEuView
...
class TaxRegisteredInEuControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val taxRegisteredInEuRoute = routes.TaxRegisteredInEuController.onPageLoad(NormalMode).url
