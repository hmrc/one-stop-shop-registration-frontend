...
import models.iv.{CallValidate, NtcService, P60Service, Passport, PayslipService}
    ...
    ".handleIvFailure" - {
      ...
      "must redirect to the Incomplete page when the result was Incomplete" in {
        ...
        running(application) {
          ...
          status(result) mustEqual SEE_OTHER
          redirectLocation(result).value mustEqual routes.IvReturnController.incomplete(continueUrl).url
        }
      }
      ...
      "must redirect to the Failed Matching page when the result was FailedMatching" in {
        ...
        running(application) {
          ...
          status(result) mustEqual SEE_OTHER
          redirectLocation(result).value mustEqual routes.IvReturnController.failedMatching(continueUrl).url
        }
      }
      ...
      "must redirect to the Failed page when the result was Failed Identity Verification" in {
        ...
        running(application) {
          ...
          status(result) mustEqual SEE_OTHER
          redirectLocation(result).value mustEqual routes.IvReturnController.failed(continueUrl).url
        }
      }
      ...
      "must redirect to the Not Enough Evidence Sources page when the result was Insufficient Evidence and all evidence sources are off" in {
        ...
        running(application) {
          ...
          status(result) mustEqual SEE_OTHER
          redirectLocation(result).value mustEqual routes.IvReturnController.notEnoughEvidenceSources(continueUrl).url
        }
      }
      ...
      "must redirect to the Insufficient Evidence page when the result was Insufficient Evidence and some evidence sources are on" in {
        ...
        running(application) {
          ...
          status(result) mustEqual SEE_OTHER
          redirectLocation(result).value mustEqual routes.IvReturnController.insufficientEvidence(continueUrl).url
        }
      }
      ...
      "must redirect to the Locked Out page when the result was Locked Oout" in {
        ...
        running(application) {
          ...
          status(result) mustEqual SEE_OTHER
          redirectLocation(result).value mustEqual routes.IvReturnController.lockedOut(continueUrl).url
        }
      }
      ...
      "must redirect to the User Aborted page when the result was User Aborted" in {
        ...
        running(application) {
          ...
          status(result) mustEqual SEE_OTHER
          redirectLocation(result).value mustEqual routes.IvReturnController.userAborted(continueUrl).url
        }
      }
      ...
      "must redirect to the Timeout page when the result was Timeout" in {
        ...
        running(application) {
          ...
          status(result) mustEqual SEE_OTHER
          redirectLocation(result).value mustEqual routes.IvReturnController.timeout(continueUrl).url
        }
      }
      ...
      "must redirect to the Technical Issue page when the result was Technical Issue" in {
        ...
        running(application) {
          ...
          status(result) mustEqual SEE_OTHER
          redirectLocation(result).value mustEqual routes.IvReturnController.technicalIssue(continueUrl).url
        }
      }
      ...
      "must redirect to the Precondition Failed page when the result was Precondition Failed" in {
        ...
        running(application) {
          ...
          status(result) mustEqual SEE_OTHER
          redirectLocation(result).value mustEqual routes.IvReturnController.preconditionFailed(continueUrl).url
        }
      }
      ...
      "must redirect to the IvReturnController error page when the result was None" in {
        ...
        running(application) {
          ...
          status(result) mustEqual SEE_OTHER
          redirectLocation(result).value mustEqual routes.IvReturnController.error(continueUrl).url
        }
      }
