    ...
    ".handleIvFailure" - {
      ...
      "must redirect to the Incomplete page when the result was Incomplete" in {
        ...
        running(application) {
          ...
          status(result) mustEqual SEE_OTHER
          redirectLocation(result).value mustEqual routes.IvReturnController.incomplete().url
        }
      }
      ...
      "must redirect to the Not Enough Evidence Sources page when the result was Insufficient Evidence and all evidence sources are off" in {
        ...
        running(application) {
          ...
          status(result) mustEqual SEE_OTHER
          redirectLocation(result).value mustEqual routes.IvReturnController.notEnoughEvidenceSources().url
        }
      }
      ...
      "must redirect to the Insufficient Evidence page when the result was Insufficient Evidence and some evidence sources are on" in {
        ...
        running(application) {
          ...
          status(result) mustEqual SEE_OTHER
          redirectLocation(result).value mustEqual routes.IvReturnController.insufficientEvidence().url
        }
      }
      ...
      "must redirect to the Locked Out page when the result was Locked Oout" in {
        ...
        running(application) {
          ...
          status(result) mustEqual SEE_OTHER
          redirectLocation(result).value mustEqual routes.IvReturnController.lockedOut().url
        }
      }
      ...
      "must redirect to the Timeout page when the result was Timeout" in {
        ...
        running(application) {
          ...
          status(result) mustEqual SEE_OTHER
          redirectLocation(result).value mustEqual routes.IvReturnController.timeout().url
        }
      }
      ...
      "must redirect to the Technical Issue page when the result was Technical Issue" in {
        ...
        running(application) {
          ...
          status(result) mustEqual SEE_OTHER
          redirectLocation(result).value mustEqual routes.IvReturnController.technicalIssue().url
        }
      }
