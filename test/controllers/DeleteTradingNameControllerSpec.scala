...
class DeleteTradingNameControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val deleteTradingNameRoute = routes.DeleteTradingNameController.onPageLoad(NormalMode).url
  ...
  "DeleteTradingName Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(DeleteTradingNamePage, true).success.value
