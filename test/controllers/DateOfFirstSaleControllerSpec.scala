...
class DateOfFirstSaleControllerSpec extends SpecBase with MockitoSugar {
  ...
  private implicit lazy val dataRequest: AuthenticatedDataRequest[AnyContent] = AuthenticatedDataRequest(getRequest, testCredentials, vrn, None, emptyUserAnswers, None, 0, None, Some(intNumber), None)
