...
import scala.concurrent.Future
  ...
  class AuthenticatedDataRequiredActionSpec extends SpecBase with MockitoSugar with EitherValues {

//  class Harness (
//                  registrationConnector: RegistrationConnector,
//                             ) extends AuthenticatedDataRequiredAction(registrationConnector) {
//    def callRefine[A](request: AuthenticatedOptionalDataRequest[A]): Future[Either[Result, AuthenticatedDataRequest[A]]] = refine(request)
//  }


  // TODO
//  "Authenticated Data Required Action" - {
//
