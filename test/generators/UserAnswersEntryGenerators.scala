...
trait UserAnswersEntryGenerators extends PageGenerators with ModelGenerators {
  ...
  implicit lazy val arbitraryBusinessTaxIdNumberUserAnswersEntry: Arbitrary[(BusinessTaxIdNumberPage.type, JsValue)] =
    Arbitrary {
      for {
        page  <- arbitrary[BusinessTaxIdNumberPage.type]
