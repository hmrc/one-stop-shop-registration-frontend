...
class CheckDateOfFirstSaleAmendableFilterImpl(mode: Option[Mode],
...
class CheckDateOfFirstSaleAmendableFilterProvider @Inject()(
                                                           registrationService: RegistrationService
                                                         )(implicit val executionContext: ExecutionContext) {
  def apply(mode: Option[Mode]): CheckDateOfFirstSaleAmendableFilterImpl = {
    new CheckDateOfFirstSaleAmendableFilterImpl(mode, registrationService)
  }
}
