...
import forms.euVatDetails.FixedEstablishmentTradingNameFormProvider
import models.requests.DataRequest
import models.{Country, Index, Mode}
import navigation.Navigator
import pages.euVatDetails.FixedEstablishmentTradingNamePage
import pages.euVatDetails.{EuCountryPage, FixedEstablishmentTradingNamePage}
import play.api.i18n.{I18nSupport, MessagesApi}
import play.api.mvc.{Action, AnyContent, MessagesControllerComponents, Result}
import uk.gov.hmrc.play.bootstrap.frontend.controller.FrontendBaseController
import views.html.euVatDetails.FixedEstablishmentTradingNameView
