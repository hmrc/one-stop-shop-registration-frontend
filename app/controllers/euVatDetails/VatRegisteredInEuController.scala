...
import forms.euVatDetails.VatRegisteredInEuFormProvider
import models.Mode
...
import views.html.euVatDetails.VatRegisteredInEuView
    ...
    implicit request =>
      ...
      form.bindFromRequest().fold(
        ...
        value =>
          ...
          } yield Redirect(navigator.nextPage(VatRegisteredInEuPage, mode, updatedAnswers))
      )
  }
}
