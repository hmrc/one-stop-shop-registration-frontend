...
class FrontendAppConfig @Inject() (configuration: Configuration) {
  ...
  val emailVerificationContinueUrl: String      = configuration.get[String]("urls.emailVerificationContinueUrl")
  val emailVerificationContinueCheckModeUrl: String      = configuration.get[String]("urls.emailVerificationContinueCheckModeUrl")
